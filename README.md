Journée validante autour des événements en Javascript :
...
Indice 2 : Pour modifier le rendu visuel de toute la page, il faut que tu joues avec les classes de .
...
Indice 4 : Pour éviter que les classes s'accumulent, et pour que chaque touche ait un comportement propre, retire toutes les classes du à chaque fois qu'un "keypress" est détecté. Ensuite seulement tu rajoutes les classes nécessaires.
